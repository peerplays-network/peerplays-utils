...
if grep -rnE --exclude-dir=".idea" --exclude-dir="caliper-publish" --exclude-dir="coverage" "['\"]caliper-(cli|core|burrow|ethereum|fabric|fisco-bcos|iroha|peerplays|sawtooth)['\"]" . ; then
